...
Imagine 1,000 ride requests per group (positive = "actually accepted"). **Note the different base rates** — that's what makes the theorem bite.

<div class="two-col">
<div class="col-narrow">
<p><b>Non-minority</b> (acceptance rate 60%)</p>
<table>
...
<div class="col-narrow">
<p><b>Minority</b> (acceptance rate 40%)</p>
<table>
<tr><th></th><th>Pred = 1</th><th>Pred = 0</th></tr>
...
**Precision = TP / (TP + FP)** — when the model says "accept", how often is it right?

$$\text{Non-minority: } \tfrac{540}{540 + 95} \approx 0.85 \qquad \text{Minority: } \tfrac{240}{240 + 40} \approx 0.86$$

**Equal precision → predictive parity holds ✓** (Northpointe's argument).

--

**TPR = TP / (TP + FN)** — of the riders who *would* be accepted, how many does the model catch?

$$\text{Non-minority: } \tfrac{540}{540 + 60} = 0.90 \qquad \text{Minority: } \tfrac{240}{240 + 160} = 0.60$$

**TPR gap of 0.30 → equalized odds broken ✗** (ProPublica's argument). Same model, both sides right.
